...
const products = [
  { img: lvtImg,  name: 'LVT',     desc: 'Luxury Vinyl Tile' },
  { img: epcImg,  name: 'EPC',     desc: 'Engineered Polymer Composite' },
  { img: spcImg,  name: 'SPC',     desc: 'Stone Plastic Composite' },
  { img: oakImg,  name: 'OAKWOOD', desc: 'Engineered Floor' },
]
      ...
      <section className="col-products">
        <div className="col-products__container">
          {products.map(({ img, name, desc }) => (
            <div className="col-product" key={name}>
